...
import com.martinrgb.shaderexample.rendereralternative.util.Constants;
import com.martinrgb.shaderexample.rendereralternative.util.TextReader;
...
public class ShaderProgram {
    ...
    public void setupShaderInputs(int program, int[] iResolution, int[] iTextures,float time) {
        ...
        int vTexCoordLocation = GLES20.glGetAttribLocation(program, "a_texcoord");
