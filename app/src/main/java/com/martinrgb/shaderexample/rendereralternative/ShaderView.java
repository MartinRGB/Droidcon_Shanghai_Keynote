...
public class ShaderView extends GLSurfaceView {
	...
	public void setFragmentShader(String src, float quality,int[] texrues) {
		onPause();
		renderer.setFragmentShader(src, quality,texrues);
		onResume();
	}

	public void setFragmentShader(int shaderid, float quality,int[] texrues) {
		onPause();
		renderer.setFragmentShader(shaderid, quality,texrues);
		onResume();
	}
