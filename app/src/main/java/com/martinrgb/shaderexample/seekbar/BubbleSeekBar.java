package com.martinrgb.shaderexample.seekbar;
...
import static com.martinrgb.shaderexample.seekbar.BubbleSeekBar.TextPosition.BELOW_SECTION_MARK;
import static com.martinrgb.shaderexample.seekbar.BubbleSeekBar.TextPosition.BOTTOM_SIDES;
import static com.martinrgb.shaderexample.seekbar.BubbleSeekBar.TextPosition.SIDES;
import static com.martinrgb.shaderexample.seekbar.BubbleUtils.dp2px;
import static com.martinrgb.shaderexample.seekbar.BubbleUtils.sp2px;
...
public class BubbleSeekBar extends View {
    ...
    private void calculateRadiusOfBubble() {
        ...
        if (isShowProgressInFloat) {
            ...
            if (isRtl) {
                text = isFloatType ? float2String(mMax) : String.valueOf(mMax);
            } else {
                text = isFloatType ? float2String(mMin) : String.valueOf(mMin);
            }
        }
    ...
    private void autoAdjustSection() {
        ...
        float x_ = bigDecimal.setScale(2, BigDecimal.ROUND_HALF_UP).floatValue();
